<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/wwwroot/47.95.115.143/application/index/view/index/news.html";i:1557393667;s:68:"/www/wwwroot/47.95.115.143/application/index/view/common/header.html";i:1560754594;s:68:"/www/wwwroot/47.95.115.143/application/index/view/common/footer.html";i:1558603758;}*/ ?>
...
<body>
    ...
    <section>
        <!-- <img src="/public/pc/img/12.png" alt="" class="page-img"> -->
            ...
            <img src="<?php if($d['id']==19 || $d['id']==22): ?><?php echo $d['thumb']; endif; ?>" class="page-img">
        ...
        <div class="news-page page">
            <div class="news-module">
                <?php if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?>
                    <a href="<?php echo url('index/detail_nav',['nav_id'=>$n['nav_id']]); ?>">
