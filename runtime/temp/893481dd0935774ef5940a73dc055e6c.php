<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/www/wwwroot/47.95.115.143/application/index/view/index/joinus.html";i:1560240816;s:68:"/www/wwwroot/47.95.115.143/application/index/view/common/header.html";i:1560754594;s:68:"/www/wwwroot/47.95.115.143/application/index/view/common/footer.html";i:1558603758;}*/ ?>
...
<body>
   ...
   <!--  <section>
         <img src="/public/pc/img/16.png" class="page-img" alt=""> 
         <img src="<?php if($d['id']==20): ?><?php echo $d['thumb']; endif; ?>" class="page-img">
        <div class="page">
  ...
  <section>
        <!-- <img src="/public/pc/img/12.png" alt="" class="page-img"> -->

            <img src="<?php if($d['id']==20): ?><?php echo $d['thumb']; endif; ?>" class="page-img">

        <div class="news-page page">
            <?php if(is_array($news) || $news instanceof \think\Collection || $news instanceof \think\Paginator): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?>
            <div class="news-module mypos">
                    <div class="page-news-img">
                        <img src="<?php echo $n['document']; ?>" alt="">
                    </div>
                    <div class="news-hanzi">
                        ...
                        <div class="news-message">
                            <span class="news-liulan">浏览量：<?php echo $n['click']; ?></span>
                            <span class="news-date">时间：<?php echo date(('Y-m-d'),$n['inputtime']); ?></span>
                        </div>
                    </div>
                    <a href="<?php echo url('index/detail_nav',['nav_id'=>$n['nav_id']]); ?>" class="myposa">查看更多</a>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
                ...
                .myposa{
                    ...
                    .pages_other > .pagination > li > span,.pages_other > .pagination > li > a {color: #red;padding: 0 10px; display: block;height: 30px; line-height: 30px;}
                </style>
            </div>
