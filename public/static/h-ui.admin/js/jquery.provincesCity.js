 ...
 * @params   暂无
 */
$.fn.ProvinceCity = function(p,c,a){
	var _self = this;
	//定义3个默认值
	...
	$sel1.change(function(){
		...
		if(index1==0){	//当选择的为 “请选择” 时
			...
			$.each( GT[index1-1] , function(index,data){
				//$sel2.append("<option value='"+data+"'>"+data+"ccccc</option>");
				...
				if(data == c){
					...
					$.each( GC[index1-1][index_2] , function(index,data){
						//$sel3.append("<option value='"+data+"'>"+data+"aaaaa</option>");
						//alert(data);
						if(data == a){
							$sel3.append("<option value='"+data+"' selected>"+data+"</option>");
						}else{
