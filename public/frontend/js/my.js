$(function(){
    var wd=screen.width;
    if(wd<1900){
        $('.bug').css('marginTop','20px');
        $('.about').css('height','500px');
    }else{
        $('.slider7').css('height','700px');
    }
    $('.title li').click(function(){
	
        $(this).addClass('active').siblings().removeClass('active');
    })
    $('.about_main .box .d2 li').click(function(){
        $(this).addClass('active').siblings().removeClass('active');
        var index=$(this).index();
        $('.about_main .box .dd ul').eq(index).addClass('active').siblings().removeClass('active');
    })
    $('.new_main .box .d1 li').click(function(){
        $(this).addClass('active').siblings().removeClass('active');
        var index=$(this).index();
        $('.new_main .box .d2 ul').eq(index).addClass('active').siblings().removeClass('active');
    })
    $('.new_main .box .d3 li').click(function(){
        $(this).addClass('active').siblings().removeClass('active');
    })
    $('.main .box-1 li').hover(function(){
        $(this).find('.panter').hide();
